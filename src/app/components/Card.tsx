...
const floatingImageContentBlock = () => {
  return (
    <section className="container mx-auto py-10 flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mc:pr-10">
        ...
        <ul className="text-white">
          ...
          <br />
          <li>
            <strong>Mashroom Swiss Burger:</strong> Juicy beef patty melted
        ...
        <div className="md:w-1/2 mt-6 md:mt-0">
          <img
            src="https://img.freepik.com/free-vector/restaurant-mural-wallpaper_23-2148706001.jpg?t=st=1727452947~exp=1727456547~hmac=9d499d2c7676faf33e85416394252c63ee78f97c767223207f32533def5ddd618w=740"
